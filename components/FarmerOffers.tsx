        ...
        <div className="mt-6 rounded-2xl bg-[#FBF7EF] p-5">
            ...
            {offer.status === "accepted" && offer.dealStage === "offer-accepted" && offer.paymentStatus !== "PAID" && (
                <div className="mt-5 rounded-xl border border-[#E8D5A6] bg-[#FFF4D6] p-4 text-center">
                    <p className="text-sm font-semibold text-[#9A6B00]">Waiting for the vendor to complete payment.</p>
        ...
        <section className="mt-6 rounded-3xl border border-[#E4DCC8] bg-white shadow-sm">
            <div className="flex flex-col gap-3 border-b border-[#E4DCC8] bg-[#FBF7EF] p-5 sm:flex-row sm:items-center sm:justify-between sm:p-6">
                <div>
                    ...
                    <h3 className="mt-1 font-serif text-xl font-semibold text-[#1B4332]">Vendor Payment Status</h3>
                    <p className="mt-1 text-xs text-[#8A8370]">The vendor is responsible for paying the accepted offer.</p>
                </div>
            ...
            {offer.paymentStatus === "PAID" && (
                <div className="mx-5 mb-5 rounded-2xl border border-[#B9D9C5] bg-[#EAF1EC] p-4 text-center sm:mx-6 sm:mb-6">
                    <p className="text-sm font-semibold text-[#1B6B43]">✓ Payment received from the vendor.</p>
            ...
            <div className="mx-auto max-w-5xl">
                ...
                <section className="mb-6 rounded-3xl bg-[#1B4332] p-6 text-[#FBF7EF] shadow-lg sm:p-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-sm text-[#D8E5DC]">Review vendor offers, payment status and deal progress.</p>
                        </div>
                    </div>
                </section>
                ...
                {offers.length === 0 && (
                    <div className="rounded-3xl border border-dashed border-[#E4DCC8] bg-white p-12 text-center">
                        ...
                        <p className="mt-2 text-sm text-[#8A8370]">When vendors make offers on your crops, they will appear here.</p>
                        ...
                        <section key={offer.id} className="rounded-3xl border border-[#E4DCC8] bg-white p-5 shadow-sm sm:p-6">
                            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="font-semibold text-[#1B4332]">{offer.vendorName}</p>
                                        <p className="text-xs text-[#8A8370]">Vendor offer</p>
                                    </div>
                                </div>
                            ...
                            {offer.status === "cancelled" && (
                                <div className="mt-5 rounded-2xl bg-[#F1EDE5] p-4 text-center"><p className="text-sm font-semibold text-[#6F685B]">This offer was cancelled by the vendor.</p></div>
                            )}
                        </section>
                    ))}
                </div>
